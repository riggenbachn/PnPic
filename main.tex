...
\begin{remark}
    ...
    Now $ R^{\varphi C_2 } \to \pi_0 R^{\varphi C_2} $ is a limit of nilpotent extensions; use deformation theory to try to lift any given trivialization of $  A \otimes_R \pi_0 R^{\varphi C_2} $ to a trivialization of $ A \otimes_{R} R^{\varphi C_2} $. \Lucy{tried to put this in a comment but TeX would not compile :/}
\end{remark}
