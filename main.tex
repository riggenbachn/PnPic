...
\begin{lemma}\label{lemma:restriction_functor_cat_as_fibrations}
    ...
    \begin{enumerate}[label=(\alph*)]
        \item If $ \mathcal{C} $ has finite colimits, then the functor $ d_1^* \colon \Fun\left(\Delta^2, \mathcal{C}\right) \to \Fun\left(\Delta^1, \mathcal{C}\right) $ exhibits the source as a cocartesian fibration over the target. 
        ...
        \item If $ \mathcal{C} $ has finite limits, then $ d_1^* $ exhibits the source as a cartesian fibration over the target. 
...
\begin{proof}
    ...
    \end{equation*}
    where $ i $ classifies the morphism $ 00 \to 10 $ and $ j $ sends the edge $ 10 \to 11 $ (i.e. the unique nonidentity in $ \{1\} \times \Delta^1 $) to the identity at $ 2 $ in $ \Delta^2 $; note that their composite is $ j \circ i = \delta_1 $. 
    ...
    In particular, $ i^* $-cocartesian transport along a morphism in $ \mathcal{C}^{\Delta^1} $ corresponds to taking a pushout in $ \mathcal{C}^{\Delta^1} $. 
...
\begin{proof}
    ...
    It is clear that $ (-)^u $ preserves small filtered colimits, since they are computed in $ \Spectra^{C_2} $. 
