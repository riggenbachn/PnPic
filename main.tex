...
\begin{proof} [Proof of Lemma \ref{lemma:poincare_morita_eq_is_open_subsheaf}]
    ...
    By the proof of Lemma \ref{lemma:hermitian_moduli_to_ordinary_moduli_is_geometric}, we know that $ (F,\eta) $ is given by $ (-\otimes_R M, \widetilde{p}^*A \to N^{C_2}_R(M^\vee)) $. 
    By quasiperfection of $ \pi_* $ and flatness of $ \pi $, $ M $ is a compact $ S $-module. 
...
\begin{proof}
    ...
    \begin{itemize} 
        ...
        \item If $ \ell(P) > 1 $, then there exists a perfect $ R^e $-module $ Q $ and an exact sequence of $ R^e $-modules $ P \to Q \to \Sigma^a R^e $ for some $ a \in \ZZ $. 
        ...
        Therefore $ N^{C_2}_R $ sends the cube to a cartesian cube in $ \Mod_R\left(\Spectra^{C_2}\right) $, hence $ N^{C_2}_R(P) $ can be written as a finite limit of perfect $ R $-modules. \qedhere
    \end{itemize}  
\end{proof}
