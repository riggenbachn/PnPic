...
\begin{construction}
    ...
    Combining (\ref{diagram:calgp_to_functor_cat_with_pointed_target}) with Lemma \ref{lemma:stable_cat_functorial_Yoneda}, we obtain a commutative diagram\Lucyil{replace $ \Catex $ by \emph{`large'} stable $ \infty $-categories, add remark about $ \Cat^\epoly $ earlier}
