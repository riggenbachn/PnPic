...
In particular, for any $ \infty $-category $ \mathcal{M} $ left $ \EE_\sigma $-tensored over $ \mathcal{C} $ and any object $ M \in \mathcal{M} $ which is fixed by the involution on $ \mathcal{M} $, we expect the endomorphisms of $ \mathcal{M} $ to admit the structure of an $ \EE_\sigma $-algebra in $ \mathcal{C} $. 
