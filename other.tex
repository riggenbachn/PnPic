...
\begin{observation}
    ...
    Then there is a map of $ \infty $-categories $ N^\otimes(P) \to N^\otimes (O) $ where the former denotes the operadic nerve of \cite[Definition 2.1.1.23]{LurHA} and the latter denotes the genuine operadic nerve. \Lucy{todo: sends inert to inert? image is contained in non-parametrized fiber over $ U $.} 
\end{observation}
\begin{construction}
